...
public class Page1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mondayTextView = findViewById(R.id.monday_text_view_1);
        TextView tuesdayTextView = findViewById(R.id.tuesday_text_view_1);
        TextView wednesdayTextView = findViewById(R.id.wednesday_text_view_1);
        TextView thursdayTextView = findViewById(R.id.thursday_text_view_1);
        TextView fridayTextView = findViewById(R.id.friday_text_view_1);
        TextView saturdayTextView = findViewById(R.id.saturday_text_view_1);
        ...
        saturdayTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Ваш код для вывода списка предметов на пятницу
                Toast.makeText(Page1Activity.this, "Список предметов на субботу", Toast.LENGTH_SHORT).show();
            }
        });
